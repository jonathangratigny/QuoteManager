...
?>
    ...
    <body class="d-flex h-100 text-center text-white bg-dark stop">
                ...
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto mb-3">
                            ...
                            <div>My Ref : <?= $value['project_owner_ref'] ?? null ?></div>
                                ...
                                <div class="modal-body bg-light">
                                    <ul class="list-group ">
                                        <li class="list-group-item">
                                            ...
                                            <?php if (($maxWidthContainer['max_width'] - $getContainerDimensions['container_df_width']) > 0) { ?>
                                            ...
                                            <?php } else { ?>
                                                <div> Widht : <?= $dataContainer['container_df_type'] == '40FR' ? $maxWidthContainer['max_width'] . 'cm ⇨ No Over Width.' : ($dataContainer['container_df_type'] == '20FR' ? $maxWidthContainer['max_width'] . 'cm ⇨ No Over Width.'  : ($dataContainer['container_df_type'] == '40HC' ? $getContainerDimensions['container_df_width'] . 'cm' : ($dataContainer['container_df_type'] == '20GP' ? $getContainerDimensions['container_df_width'] . 'cm' : 'Error'))) ?> </div>
                                            <?php } ?>
                                            <?php if ($maxHeightContainer['max_height'] - $getContainerDimensions['container_df_height'] > 0) { ?>
                                                <p> Height : <?= $dataContainer['container_df_type'] == '40FR' ? $maxHeightContainer['max_height'] . 'cm ⇨ ' . ($maxHeightContainer['max_height'] - $getContainerDimensions['container_df_height']) . 'cm Over Height.' : ($dataContainer['container_df_type'] == '20FR' ? $maxHeightContainer['max_height'] . 'cm ⇨ ' . ($maxHeightContainer['max_height'] - $getContainerDimensions['container_df_height']) . 'cm Over Height.' : ($dataContainer['container_df_type'] == '40HC' ? $getContainerDimensions['container_df_height'] . 'cm' : ($dataContainer['container_df_type'] == '20GP' ? $getContainerDimensions['container_df_height'] . 'cm' : 'Error'))) ?> </p>
                                                <p> Gross weight : <?= $totalGrossWeight['total_gross_weight'] ?>kg</p>
                                            <?php } else { ?>
                                                <p> Height : <?= $dataContainer['container_df_type'] == '40FR' ? $maxHeightContainer['max_height'] . 'cm ⇨ No Over Height.' : ($dataContainer['container_df_type'] == '20FR' ? $maxHeightContainer['max_height'] . 'cm ⇨ No Over Height.' : ($dataContainer['container_df_type'] == '40HC' ? $getContainerDimensions['container_df_height'] . 'cm' : ($dataContainer['container_df_type'] == '20GP' ? $getContainerDimensions['container_df_height'] . 'cm' : 'Error'))) ?> </p>
                                                <p> Gross weight : <?= $totalGrossWeight['total_gross_weight'] ?>kg</p>
                                            <?php } ?>
                                        </li>
                                    </ul>
