...
table20GP.addEventListener('click', function () {
    ...
    newTable.setAttribute("id", defaultContainerValue[1]['container_df_type'] + index);
    tableContainer.append(newTable);
    newTable.innerHTML = `
    <caption>Container ${defaultContainerValue[1]['container_df_type']} #${index}</caption>
    <thead>
        <tr>
    ...
    dataLength.forEach(crate_length => {
        crate_length.addEventListener('change', function () {
            ...
            dataLength.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[1]['container_df_length'])) {
            ...
            if (length.value >= parseInt(defaultContainerValue[1]['container_df_length'])) {
                alert(`Overlength in ${defaultContainerValue[1]['container_df_type']} (${parseInt(defaultContainerValue[1]['container_df_length'])}cm max), please check the lengths.`)
                length.value = '';
    ...
    dataWidth.forEach(crate_width => {
        crate_width.addEventListener('change', function () {
            ...
            dataWidth.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[1]['container_df_width'])) {
                    alert(`please update this line, ${bigValue.value}cm is over width in ${defaultContainerValue[1]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataHeight.forEach(crate_height => {
        crate_height.addEventListener('change', function () {
            ...
            dataHeight.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[1]['container_df_height'])) {
                    alert(`please update this line, ${bigValue.value}cm over height in ${defaultContainerValue[1]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataWeight.forEach(crate_weight => {
        crate_weight.addEventListener('change', function () {
            ...
            if (countdataWeight.value > parseInt(defaultContainerValue[1]['container_df_payload'])) {
                alert(`${countdataWeight.value}kg is over payload in ${defaultContainerValue[1]['container_df_type']}!`);
...
table40HC.addEventListener('click', function () {
    ...
    let newTable = document.createElement("table");
    newTable.setAttribute("class", "table table-bordered table-sm");
    newTable.setAttribute("id", defaultContainerValue[0]['container_df_type'] + index);
    tableContainer.append(newTable);
    newTable.innerHTML = `
    <caption>Container ${defaultContainerValue[0]['container_df_type']} #${index}</caption>
    <thead>
        <tr>
            <th scope="col">Crate Ref</th>
            <th scope="col">Length</th>
    ...
    dataLength.forEach(crate_length => {
        crate_length.addEventListener('change', function () {
            ...
            //case if one crate is >max length
            dataLength.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[0]['container_df_length'])) {
                    alert(`please update this line, ${bigValue.value}cm is over length.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
            ...
            if (length.value >= parseInt(defaultContainerValue[0]['container_df_length'])) {
                alert(`Overlength in ${defaultContainerValue[0]['container_df_type']} (${parseInt(defaultContainerValue[0]['container_df_length'])}cm max), please check the lengths.`)
                length.value = '';
            } else if (length.value == 0) {
                length.value = '';
            }
    ...
    dataWidth.forEach(crate_width => {
        crate_width.addEventListener('change', function () {
            ...
            //case if one crate is >max width
            dataWidth.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[0]['container_df_width'])) {
                    alert(`please update this line, ${bigValue.value}cm is over width in ${defaultContainerValue[0]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataHeight.forEach(crate_height => {
        crate_height.addEventListener('change', function () {
            ...
            //case if one crate is >max height
            dataHeight.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[0]['container_df_height'])) {
                    alert(`please update this line, ${bigValue.value}cm over height in ${defaultContainerValue[0]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataWeight.forEach(crate_weight => {
        crate_weight.addEventListener('change', function () {
            ...
            if (countdataWeight.value > parseInt(defaultContainerValue[0]['container_df_payload'])) {
                alert(`${countdataWeight.value}kg is over payload in ${defaultContainerValue[0]['container_df_type']}!`);
                countdataWeight.value = '';
            }
        })
    })
...
table20FR.addEventListener('click', function () {
    ...
    let newTable = document.createElement("table");
    newTable.setAttribute("class", "table table-bordered table-sm");
    newTable.setAttribute("id", defaultContainerValue[2]['container_df_type'] + index);
    tableContainer.append(newTable);
    newTable.innerHTML = `
    <caption>Container ${defaultContainerValue[2]['container_df_type']} #${index}</caption>
    <thead>
        <tr>
            <th scope="col">Crate Ref</th>
            <th scope="col">Length</th>
    ...
    dataLength.forEach(crate_length => {
        crate_length.addEventListener('change', function () {
            ...
            //case if one crate is > max length
            dataLength.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[2]['container_df_length'])) {
                    alert(`please update this line, ${bigValue.value}cm is over length.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
            ...
            //case if total length is > max length
            if (length.value >= parseInt(defaultContainerValue[2]['container_df_length'])) {
                alert(`Overlength in ${defaultContainerValue[2]['container_df_type']} (${parseInt(defaultContainerValue[2]['container_df_length'])}cm max), please check the lengths.`)
                length.value = '';
            } else if (length.value == 0) {
                length.value = '';
            }
    ...
    dataWidth.forEach(crate_width => {
        crate_width.addEventListener('change', function () {
            ...
            //case if one crate is >max width
            dataWidth.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[2]['container_df_width'])) {
                    alert(`please update this line, ${bigValue.value}cm is over width in ${defaultContainerValue[2]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataHeight.forEach(crate_height => {
        crate_height.addEventListener('change', function () {
            ...
            //case if one crate is >max height
            dataHeight.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[2]['container_df_height'])) {
                    alert(`please update this line, ${bigValue.value}cm over height in ${defaultContainerValue[2]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataWeight.forEach(crate_weight => {
        crate_weight.addEventListener('change', function () {
            ...
            if (countdataWeight.value > parseInt(defaultContainerValue[2]['container_df_payload'])) {
                alert(`${countdataWeight.value}kg is over payload in ${defaultContainerValue[2]['container_df_type']}!`);
                countdataWeight.value = '';
            }
        })
    })
...
table40FR.addEventListener('click', function () {
    ...
    let newTable = document.createElement("table");
    newTable.setAttribute("class", "table table-bordered table-sm");
    newTable.setAttribute("id", defaultContainerValue[3]['container_df_type'] + index);
    tableContainer.append(newTable);
    newTable.innerHTML = `
    <caption>Container ${defaultContainerValue[3]['container_df_type']} #${index}</caption>
    <thead>
        <tr>
            <th scope="col">Crate Ref</th>
            <th scope="col">Length</th>
    ...
    dataLength.forEach(crate_length => {
        crate_length.addEventListener('change', function () {
            ...
            //case if one crate is > max length
            dataLength.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[3]['container_df_length'])) {
                    alert(`please update this line, ${bigValue.value}cm is over length.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
            ...
            //case if total length is > max length
            if (length.value >= parseInt(defaultContainerValue[3]['container_df_length'])) {
                alert(`Overlength in ${defaultContainerValue[3]['container_df_type']} (${parseInt(defaultContainerValue[3]['container_df_length'])}cm max), please check the lengths.`)
                length.value = '';
            } else if (length.value == 0) {
                length.value = '';
            }
    ...
    dataWidth.forEach(crate_width => {
        crate_width.addEventListener('change', function () {
            ...
            //case if one crate is >max width
            dataWidth.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[3]['container_df_width'])) {
                    alert(`please update this line, ${bigValue.value}cm is over width in ${defaultContainerValue[3]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataHeight.forEach(crate_height => {
        crate_height.addEventListener('change', function () {
            ...
            //case if one crate is >max height
            dataHeight.forEach(bigValue => {
                if (bigValue.value > parseInt(defaultContainerValue[3]['container_df_height'])) {
                    alert(`please update this line, ${bigValue.value}cm over height in ${defaultContainerValue[3]['container_df_type']}.`);
                    bigValue.focus;
                    bigValue.setActive;
                    bigValue.select();
                    countMaxWidth.value = '';
    ...
    dataWeight.forEach(crate_weight => {
        crate_weight.addEventListener('change', function () {
            ...
            if (countdataWeight.value > parseInt(defaultContainerValue[3]['container_df_payload'])) {
                alert(`${countdataWeight.value}kg is over payload in ${defaultContainerValue[3]['container_df_type']}!`);
                countdataWeight.value = '';
            }
        })
    })
